...
import { getPopularVideos } from '@/lib/supabase';
...
export default function PopularVideos({
  ...
  useEffect(() => {
    const fetchPopularVideos = async () => {
      try {
        setLoading(true);
        const videosData = await getPopularVideos(limit);
        console.log('Found popular videos:', videosData.length);
            ...
            >
              ...
              >
                ...
                <div className="flex justify-between items-center mt-2 text-sm text-gray-500">
                  <span>再生回数: {video.view_count || 0}</span>
