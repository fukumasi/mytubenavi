   ...
   const fetchProfileData = async () => {
     try {
       ...
       setFavoriteVideos((parsedFavorites || []).map(f => ({
         ...
         channelTitle: f.video.channel_title,
         publishedAt: f.video.published_at,
         viewCount: f.video.view_count,
       ...
       setViewHistory((parsedHistory || []).map(h => ({
         ...
         channelTitle: h.video.channel_title,
         publishedAt: h.video.published_at,
         viewCount: h.video.view_count,
